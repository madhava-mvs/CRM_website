...
export default function Userprofile() {
  ...
  const SAVEclick = (e) => {
    if (
      ...
      const url =
        "https://8mtnecluj6.execute-api.us-east-1.amazonaws.com/dev/updateprofile";
      const data = {
        id: userid,
        Email: Email,
        FirstName: FirstName,
  ...
  useEffect(() => {
    ...
    const url =
      " https://04m1xo4qs3.execute-api.us-east-1.amazonaws.com/dev/getprofile";
    const data = {
      id: userid,
    };
    const headers = {};
            ...
            <div className="Profile_outer">
              ...
              <div className="Profile_Info">
                <div className="Profile_outer_row1">
                  {" "}
                  <label className="erroru">{erroru}</label>
                ...
                <div className="Profileouter_row3">
                  <div className="Profile_a3">
                    ...
                    {errorall && FirstName == "" ? (
                      <label className="errorf">Firstname is mandatory</label>
                    ) : (
                      ""
                    )}
                  </div>
                  ...
                  <div className="Profile_c3">
                    ...
                    />
                    {errorall && Email == "" ? (
                      <label className="errore">Email is mandatory</label>
                    ) : (
                      ""
                    )}
                    <br />
                  ...
                  <div className="Profile_d3">
                    ...
                    />
                    {errorall && Dob == "" ? (
                      <label className="errord">Dob is mandatory</label>
                    ) : (
                      ""
                    )}
                  </div>
                ...
                <div className="Profileouter_row5">
                  <div className="Profile_a5">
                    ...
                    />
                    {errorall && Address == "" ? (
                      <label className="errora">Address is mandatory</label>
                    ) : (
                      ""
                    )}
                  </div>
                  <div className="Profile_b5">
                    ...
                    {errorall && Password == "" ? (
                      <label className="errorp">Password is mandatory</label>
                    ) : (
                      ""
                    )}
                  </div>
